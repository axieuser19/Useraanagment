-- 🛡️ PRODUCTION-GRADE SECURITY PATCHES FOR TRIAL ABUSE PREVENTION (FIXED)
...
-- ============================================================================
-- PATCH #5: SECURITY AUDIT LOG TABLE (FIXED SYNTAX)
-- ============================================================================
...
-- Create indexes separately (this is the correct PostgreSQL syntax)
CREATE INDEX IF NOT EXISTS idx_security_audit_log_user_id ON security_audit_log(user_id);
CREATE INDEX IF NOT EXISTS idx_security_audit_log_action ON security_audit_log(action);
CREATE INDEX IF NOT EXISTS idx_security_audit_log_normalized_email ON security_audit_log(normalized_email);
